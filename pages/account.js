    ...
    return (
        <div>
            ...
            <div className='abonnement-infos-container'>
                <div>
                    <h2 className='h2-title' style={{marginTop:25}}>Mon Compte</h2>
                </div>
                <div>
                    <div style={{marginBottom:40}} className='formule-actuelle'>Civilité</div>
                ...
                <div className='resp-btn' style={{display:"flex"}}>
                    <Link href='/abonnement'><button style={{marginRight:40}} className='btn-select'>Informations Abonnement</button></Link>
                    <Link href='/infochange'><button className='btn-select'>Modifier mes informations</button></Link>
                </div>
                </div>
