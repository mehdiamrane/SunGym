...
function Payments() {
    ...
    return (
        <div>
                ...
                <div className='tabs-payment'>
                    <div className='tabs'>
                        ...
                        <div style={{ backgroundColor:activeTab === 2?'yellow':'grey' }} onClick={()=>setActiveTab(2)}>Etape 2</div>
                        <div style={{ backgroundColor:activeTab === 3?'yellow':'grey' }} onClick={()=>setActiveTab(3)}>Etape 3</div>
                    </div>
                    <div className='tab-content'>
                        ...
                        <form className='paiment-form'>
                            ...
                            <label>Adresse :</label>
                            <input className='paiement-input' type='text' placeholder='ex: 2 rue des lillas'></input>
                            ...
                            <button  className='btn-select' type='submit'>Valider </button>
                        </form>
                    </div>
        ...
        <div>
                ...
                <div className='tabs-payment'>
                    <div className='tabs'>
                        <div style={{ backgroundColor:activeTab === 1?'yellow':'grey' }} onClick={()=>setActiveTab(1)}>Etape 1</div>
                    ...
                    <div className='tab-content'>
                        ...
                        <form className='paiment-form'>
                            ...
                            <button className='btn-select' type='submit'>Confirmer mon choix</button>
                        </form>
                    </div>
                ...
                <div className='tabs-payment'>
                    ...
                    <div className='tab-content'>
                        ...
                        <form className='paiment-form'>
                            ...
                            <button className='btn-select' type='submit'>Valider et payer xx.xx$</button>
                        </form>
                    </div>
